...
class German(English):
    ...
    description = """TorghostNG 1.7 - Anonymisiere all deinen Internetverkehr druch Tor
...
macchanger: https://github.com/alobbs/macchanger"""
    ...
    current_language = icon.info + " The current display language: "
    language_list = icon.info + " List of languages:\n    1.English   2.Vietnamese"
    choose_your_lang = icon.question + " Ändere deine Sprache (1/2): "
    ...
    ipv6_alreay_disabled = icon.info + " IPv6 ist bereits ausgeschaltet"
